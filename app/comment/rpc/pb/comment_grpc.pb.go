...
const (
	...
	CommentService_GetCommentsByPost_FullMethodName = "/pb.CommentService/GetCommentsByPost"
)
...
func (c *commentServiceClient) GetCommentsByPost(ctx context.Context, in *GetCommentsByPostRequest, opts ...grpc.CallOption) (*GetCommentsByPostResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCommentsByPostResponse)
...
func (UnimplementedCommentServiceServer) GetCommentsByPost(context.Context, *GetCommentsByPostRequest) (*GetCommentsByPostResponse, error) {
...
var CommentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "app/comment/rpc/pb/comment.proto",
}

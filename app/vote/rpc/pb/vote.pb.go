...
// 获取帖子投票统计的请求
type GetPostVoteCountsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetPostVoteCountsRequest) Reset() {
	*x = GetPostVoteCountsRequest{}
	mi := &file_app_vote_rpc_pb_vote_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetPostVoteCountsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPostVoteCountsRequest) ProtoMessage() {}

func (x *GetPostVoteCountsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_app_vote_rpc_pb_vote_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPostVoteCountsRequest.ProtoReflect.Descriptor instead.
func (*GetPostVoteCountsRequest) Descriptor() ([]byte, []int) {
	return file_app_vote_rpc_pb_vote_proto_rawDescGZIP(), []int{4}
}

func (x *GetPostVoteCountsRequest) GetPostId() int64 {
	if x != nil {
		return x.PostId
	}
	return 0
...
// 获取帖子投票统计的响应
type GetPostVoteCountsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Upvotes   int64 `protobuf:"varint,1,opt,name=upvotes,proto3" json:"upvotes,omitempty"`     // 赞成票数量
	Downvotes int64 `protobuf:"varint,2,opt,name=downvotes,proto3" json:"downvotes,omitempty"` // 反对票数量
}

func (x *GetPostVoteCountsResponse) Reset() {
	*x = GetPostVoteCountsResponse{}
	mi := &file_app_vote_rpc_pb_vote_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetPostVoteCountsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetPostVoteCountsResponse) ProtoMessage() {}

func (x *GetPostVoteCountsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_app_vote_rpc_pb_vote_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetPostVoteCountsResponse.ProtoReflect.Descriptor instead.
func (*GetPostVoteCountsResponse) Descriptor() ([]byte, []int) {
	return file_app_vote_rpc_pb_vote_proto_rawDescGZIP(), []int{5}
}

func (x *GetPostVoteCountsResponse) GetUpvotes() int64 {
	if x != nil {
		return x.Upvotes
	}
	return 0
...
func (x *GetPostVoteCountsResponse) GetDownvotes() int64 {
	if x != nil {
		return x.Downvotes
	}
	return 0
...
var file_app_vote_rpc_pb_vote_proto_rawDesc = []byte{
	...
	,
...
var file_app_vote_rpc_pb_vote_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_app_vote_rpc_pb_vote_proto_goTypes = []any{
	...
	(*GetPostVoteCountsRequest)(nil),  // 4: pb.GetPostVoteCountsRequest
	(*GetPostVoteCountsResponse)(nil), // 5: pb.GetPostVoteCountsResponse
}
var file_app_vote_rpc_pb_vote_proto_depIdxs = []int32{
	...
	4, // 2: pb.VoteService.GetPostVoteCounts:input_type -> pb.GetPostVoteCountsRequest
	1, // 3: pb.VoteService.VotePost:output_type -> pb.VotePostResponse
	3, // 4: pb.VoteService.GetUserVote:output_type -> pb.GetUserVoteResponse
	5, // 5: pb.VoteService.GetPostVoteCounts:output_type -> pb.GetPostVoteCountsResponse
